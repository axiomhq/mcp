 ...
 * Generated at: 2026-04-27T15:36:45.785Z
...
export const metadata: MCPMetadata = {
  "tools": [
    ...
    {
      "name": "searchMetrics",
      "description": "Start here when the user mentions a specific service, host, or entity name and you need to work with metrics data. Searches tag values across all metrics in a dataset and returns the metric names that are associated with the given entity. This is the fastest way to go from a known entity name (e.g.",
      "category": "Core"
    },
    {

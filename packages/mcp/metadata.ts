 ...
 * Generated at: 2026-04-08T23:18:35.026Z
...
export const metadata: MCPMetadata = {
  "tools": [
    ...
    {
      "name": "queryDataset",
      "description": "# Instructions 1. Query Axiom datasets using Axiom Processing Language (APL). The query must be a valid APL query string. 2. ALWAYS discover the schema before you guess. - Use getDatasetFields() for the field list. - Use a tiny probe like [",
      "category": "Core"
    },
    {
      "name": "queryMetrics",

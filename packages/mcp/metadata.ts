 ...
 * Generated at: 2025-11-17T13:40:15.359Z
...
export const metadata: MCPMetadata = {
  "tools": [
    ...
    {
      "name": "queryDataset",
      "description": "# Instructions 1. Query Axiom datasets using Axiom Processing Language (APL). The query must be a valid APL query string. 2. **CRITICAL: Nearly all APL queries must start with the dataset name in square brackets [",
      "category": "Core"
    }
  ],
  "prompts": [

...
interface LandingLayoutProps extends BaseProps {
  title: string;
}
...
export const LandingLayout: FC<LandingLayoutProps> = ({ title, children }) => {
  return (
    <html lang="en">
      ...
      <body className="min-h-screen bg-gray-50 font-mono dark:bg-gray-950">
        ...
        <div className="mx-auto max-w-[960px] px-6 py-12 md:px-8 lg:px-12">
          <main>{children}</main>
